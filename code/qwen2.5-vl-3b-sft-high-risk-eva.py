...
def argparser():
    ...
    parser.add_argument('--output', default='/root/autodl-tmp/project/output/3b_fire_risk.txt', type=str)  # 输出预测结果
    parser.add_argument('--model_path', default="/root/autodl-tmp/project/model/3B/Qwen2.5-VL-3B-Instruct-aug-12e-updata-3e", type=str)
