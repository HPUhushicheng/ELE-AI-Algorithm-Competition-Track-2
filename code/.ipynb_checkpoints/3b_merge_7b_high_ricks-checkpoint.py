# 文件路径配置
file1_path = "./output/3b_fire_risk.txt"  # qwen2.5-vl-3b-sft-high-risk预测的高风险标签
file2_path = "./output/7b_fire_risk.txt"  # 多标签分类模型qwen2.5-vl-7b-sft模型预测标签
output_path = "./output/b-submit.txt"  # 输出结果文件
