...
def argparser():
    ...
    parser.add_argument('--output', default="./output/7b_fire_risk.txt", type=str)  # 输出预测结果
    parser.add_argument('--model_path', default="/root/autodl-tmp/project/model/llyllylly/Qwen2.5-VL-7B-Instruct-fine-tuning4-lora-aug-5.4529-a1-5.1567", type=str)
