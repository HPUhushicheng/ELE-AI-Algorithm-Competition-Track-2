...
if __name__ == '__main__':
    ...
    # 输入输出路径
    input_dir = r"/root/images/train"
    output_dir = r"/root/images/train_aug"
    label_file = r"/root/images/train.txt"
    output_label_file = r"/root/images/train_aug.txt"
