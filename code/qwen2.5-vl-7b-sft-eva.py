...
def argparser():
    ...
    parser.add_argument('--prompt', default='/root/autodl-tmp/project/code/prompt/7b_risk_classification.txt', type=str)  # 消防风险提示语
    ...
    parser.add_argument('--output', default="/root/autodl-tmp/project/output/7b_fire_risk.txt", type=str)  # 输出预测结果
    parser.add_argument('--model_path', default="/root/autodl-tmp/project/model/7B/Qwen2.5-VL-7B-Instruct-fine-tuning4-lora-aug-5.4529-a1-5.1567", type=str)
